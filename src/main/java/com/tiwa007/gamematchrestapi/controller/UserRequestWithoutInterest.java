...
public class UserRequestWithoutInterest {
    ...
    public UserRequestWithoutInterest() {
    }


    public UserRequestWithoutInterest(String name, String gender, String nickname, String geography) {
        this.name = name;
        this.gender = gender;
